...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request, $id)
    {
        ...
        // update cars availability too 
        $device_id = $id;
        $old_stock = DB::table('products')->where('id', $device_id)->value('stock');
        if ($old_stock > 0) {
            $new_stock = ($old_stock - 1);
        } else {
            $new_stock = 0;
        }
        $update = DB::table('products')->where('id', $device_id)->update(['stock' => $new_stock]);
    ...
    public function success(Request $request)
    {
        ...
        return redirect('/my-bookings')->with('success', 'Thanks For Your Booking!');

        // return to_route('mybooking')->with('success', 'Thanks For Your Booking!');
    }
