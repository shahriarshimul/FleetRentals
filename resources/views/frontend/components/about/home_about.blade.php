              ...
              <form>
                ...
                <div class="text-center">
                  <p>or sign up with:</p>
                      ...
                      <button type="button" class="btn btn-primary btn-floating mx-1" onclick="window.location.href='www.mahirajabin0631@gmail.com';">
                          <i class="fab fa-google"></i>
                      </button>

                      <button type="button" class="btn btn-primary btn-floating mx-1" onclick="window.location.href='www.mahirajabin06231@twitter.com';">
                          <i class="fab fa-twitter"></i>
                      </button>

                      <button type="button" class="btn btn-primary btn-floating mx-1" onclick="window.location.href='https://github.com/MahiraJabin';">
